...
function M.apply()
  ...
  set("BufferLineBackground", { fg = c.muted, bg = "NONE" })
  set("BufferLineBufferSelected", { fg = c.foreground, bg = "NONE", bold = true })
