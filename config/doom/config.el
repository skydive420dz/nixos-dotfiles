...
(after! corfu
  ...
  (defun sk/prose-completion-quiet ()
    "Keep Corfu available in prose buffers without automatic popups."
  ...
  (dolist (hook '(org-mode-hook
                  ...
                  markdown-mode-hook
                  text-mode-hook))
    (add-hook hook #'sk/prose-completion-quiet)))
...
(map! :leader
      (:prefix ("n" . "notes")
       :desc "Open inbox" "i" #'sk/org-open-inbox
       :desc "Open today's daily note" "d" #'sk/org-open-daily-note
