...
(defun sk/apply-theme-faces ()
  "Reload Sky tokens and apply them to Doom faces."
  (interactive)
  (sk/reload-theme-tokens)
  (custom-set-faces!
    `(default :background ,(sk/theme-color 'background)
              :foreground ,(sk/theme-color 'foreground))
    `(fringe :background ,(sk/theme-color 'background))
    `(cursor :background ,(sk/theme-color 'accent))
    `(hl-line :background ,(sk/theme-color 'surface))
    `(vertical-border :foreground ,(sk/theme-color 'border))
    `(window-divider :foreground ,(sk/theme-color 'border))
    `(window-divider-first-pixel :foreground ,(sk/theme-color 'border))
    `(window-divider-last-pixel :foreground ,(sk/theme-color 'border))
  ...
  (when (called-interactively-p 'interactive)
    (message "Sky theme reloaded")))

(map! :leader
      :desc "Reload Sky theme"
      "h r t" #'sk/apply-theme-faces)
