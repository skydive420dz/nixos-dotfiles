...
- The Wi-Fi applet rule intentionally matches both =nmtui= and =wlctl=; both are launched through Ghostty classes and should share the same centered 600x600 popup behavior.
